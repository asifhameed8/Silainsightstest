export const twoFACode = (name, code) => {
    return `<!DOCTYPE html>
    <html>
        <head>
            <meta charset="utf-8" />
            ...
            <title>Mintstargram | Two FA</title>
                    ...
                    >
                        <div style="width: 100%; float: left">
                            ...
                            <p
                                ...
                                "
                            >
                                A request to login to your account
                                has been made. If you did not make this request
                                simply ignore this email. If you did make this
                                request, please enter this verfication code to login
                                successfully.
                            </p>
                            <p
                                style="
