...
const AtHolderHead = 'px-3 !font-display uppercase py-3 text-xs text-center text-black dark:text-white whitespace-nowrap text-lightText';
...
const ProfileSoldTable = ({ setTable, mobile }: Iprops) => {
        ...
        <div className=" flex flex-col">
            {mobile ? (
                ...
                <div className="flex items-center justify-between rounded-b-none rounded-t-md border-lightBorder bg-lightBg p-3 dark:bg-gray17">
                    <p className="text-sm font-semibold capitalize dark:text-chinesesilver">Sold</p>
                    <i
...
export default ProfileSoldTable;
