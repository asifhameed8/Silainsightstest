...
const AtHolderHead = 'px-2 !font-display uppercase py-3 text-xs text-center dark:text-white whitespace-nowrap text-lightText';
const AtHolderItems = 'px-2 py-[6.5px] whitespace-nowrap text-lightText text-black dark:text-white text-xs text-center';
interface Iprops {
    setTable(Table: string): void;
    mobile?: boolean;
}

const ProfileBoughtTable = ({ setTable, mobile }: Iprops) => {
        ...
        <div className=" flex flex-col">
            {mobile ? (
                ...
                <div className="flex items-center justify-between rounded-b-none rounded-t-md border-lightBorder bg-lightBg p-3 dark:bg-gray17">
                    <p className="text-sm  font-semibold capitalize dark:text-chinesesilver">Bought</p>
                    <i
                        ...
                        <table className="min-w-full rounded">
                            <thead className="sticky top-0 z-20 border-b border-lightBorder bg-lightHover dark:border-borderColor dark:bg-gray17">
                                <tr>
                                    ...
                                    <th scope="col" className={AtHolderHead}>
                                        <NameWithSortIcon className="uppercase" name="PRICE" />
                                    </th>
                                    <th scope="col" className={AtHolderHead}>
                                        action
                                    </th>
...
export default ProfileBoughtTable;
