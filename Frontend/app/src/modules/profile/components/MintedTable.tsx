...
const MintedTable = ({ setTable, mobile }: Iprops) => {
        ...
        <div className=" flex flex-col">
            {mobile ? (
                ...
                <div className=" flex items-center justify-between rounded-b-none rounded-t-md border-lightBorder bg-lightBg p-3 dark:bg-gray17">
                    <p className="text-sm  font-semibold capitalize dark:text-chinesesilver">Minted</p>
                    <i
            ...
            <div className="AtScrollHide overflow-x-auto">
                <div className="inline-block min-w-full align-middle">
                    <div className="AtScrollHide rounded-t-0 relative h-[calc(100vh-84px)] overflow-auto rounded-b-md border border-lightBorder bg-white dark:border-borderColor dark:bg-transparent xl:max-h-[23.5rem]">
