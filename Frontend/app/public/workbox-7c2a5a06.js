define(['exports'], function (t) {
    ...
    function h(t, e, n) {
        ...
        if ('string' == typeof t) {
            ...
            if (!(t instanceof r))
                throw new s('unsupported-route-type', { moduleName: 'workbox-routing', funcName: 'registerRoute', paramName: 'capture' });
            a = t;
        }
    ...
    function T(t) {
        return t !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
            ? (x || (x = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t)
                ? function (...e) {
    ...
    class tt {
        constructor({ cacheName: t, plugins: e = [], fallbackToNetwork: s = !0 } = {}) {
            (this.A = new Map()),
                (this.F = new Map()),
                (this.H = new Map()),
                (this.u = new Z({ cacheName: w(t), plugins: [...e, new J({ precacheController: this })], fallbackToNetwork: s })),
        ...
        precache(t) {
            this.addToCacheList(t),
                this.$ || (self.addEventListener('install', this.install), self.addEventListener('activate', this.activate), (this.$ = !0));
        }
        addToCacheList(t) {
            const e = [];
            for (const n of t) {
